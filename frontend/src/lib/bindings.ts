...
export type DamageRoll = { category: DamageCategory | null; damageType: Either<DamageType, string> | null; dice: number | null; die: Either<Die, number> | null; formula: string | null; kind: DamageKind | null; type: string | null; persistent: PersistentDamage | null; value: JsonValue | null }
