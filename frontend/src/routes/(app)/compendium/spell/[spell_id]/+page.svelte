...
<div class="ancestry-wrapper row">
    ...
    <div id="toc-target" class="main-content column">
        <section class="column general-info">
            <GeneralInfoHeader
                id={data.spell_id}
                name={data.spellData.name}
                publication={data.spellData.publication}
                rarity={data.spellData.rarity}
                traits={data.spellData.traits}
            />

            <p class="description column">
                {@html linkToLinkPreviewConverter(data.spellData.description)}
            </p>
        </section>
    </div>
    <TableOfContents />
