    ...
    <div id="toc-target" class="main-content column">
        <section class="column general-info">
            <div class="header row spaced-between">
                ...
                <div class="meta row">
                    <p class="id">{data.actionData.publication.title}</p>
                    <Tag>
                        <p class="license">
                            {data.actionData.publication.license}
                        </p>
                    </Tag>
                </div>
            </div>
            <Traits
                rarity={data.actionData.rarity}
                traits={data.actionData.traits}
            />

            <p class="description column">
                {@html linkToLinkPreviewConverter(data.actionData.description)}
            </p>
        </section>
    </div>
    <TableOfContents />
